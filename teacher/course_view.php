...
<div class="row">
    ...
    ?> </span>
            <div class="card m-3">
                ...
                <!-- <blockquote class="blockquote mb-0"> -->
                      <?php  
                      $user_course = $dobj->user_course($_SESSION['user']['user_id'],$_REQUEST['batch_course_id'],$_SESSION['user']['user_role_id']);
                      $count = 0;
              ...
              <div class="accordion-item">
                <h2 class="accordion-header mb-3" id="flush-headingOne">
                  ...
                  ?>
                    <input type="hidden" name="status_id" id="status_id" value="<?php echo $course_topic['status_id']; ?>">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">
                    ...
                    ?>  <a href="process.php?batch_course_id=<?php echo $_REQUEST['batch_course_id']; ?>&action=update_file&topic_file_id=<?php echo $topic_file['topic_file_id']; ?>&status_id=1&topic_id=<?php echo $course_topic['topic_id']; ?>" class=""><img src="../assets/icon_tick.png" style="height:20px; width: 20px;"></a> 
                    <?php } ?> 
                    <?php if($topic_file['status_id']==1){
                    ?> 
                    <a href="process.php?batch_course_id=<?php echo $_REQUEST['batch_course_id']; ?>&action=update_file&topic_file_id=<?php echo $topic_file['topic_file_id']; ?>&status_id=2&topic_id=<?php echo $course_topic['topic_id']; ?>" class=""><img src="../assets/icon_cross.png" style="height: 20px; width:20px;"></a>
                     <?php } ?>
                     </td> 
                     </tr>
                  <?php } 
