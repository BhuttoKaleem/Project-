...
<!-- </div> -->
            ...
            <!-- <div> -->
                ...
                <div class="col-sm-9" id="registration">
                    <!--Registration form-->   
            
            <?php $result = $dobj->select_students();
                    // var_dump($result);
            $count = 0;
                ?> 
                            <span>
              ...
              <div class="modal-body">
                <form action="process.php" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <label for="select_batch_course" class="form-label">Select course</label>
                    <span class=""  id="msgselectcourse" style="color: red;">*</span>
                    <select class="form-control" id="select_batch_course" name="batch_course_id" required="true">
                    ...
                    <?php  echo $batch_course['batch_description']." ".$batch_course['course_description'];?>
                    </option>
                    <?php } ?>
                    </select>
                  </div>
                ...
                <button type="submit" class="btn btn-primary" name="enroll_student">Enroll</button>
                  </center>
                </form>
              </div>
